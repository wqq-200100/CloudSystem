<template>
  ...
  >
    ...
    <el-table-column prop="net" label="ip" width="160"/>
    <el-table-column prop="lian" label="联系人" width="120"/>
    <el-table-column prop="xieyi" label="协议" width="120"/>
