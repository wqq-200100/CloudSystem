<template>
  ...
  <div style="margin-top: 30px;margin-left: 10px;">
    <div style="margin-top: 30px;">
      ...
      <el-button type="success" plain style="margin-left: 20px;">新增需求</el-button>
    </div>
  </div>
  ...
  >
    ...
    <el-table-column prop="lian" label="联系人" width="130"/>
    <el-table-column prop="xieyi" label="联系方式" width="130"/>
    <el-table-column prop="bei" label="需求" width="140">
